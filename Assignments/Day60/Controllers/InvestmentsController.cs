...
namespace Day60.Controllers
{
    public class InvestmentsController : Controller
    {
        ...
        {
            return View(new InvestmentViewModel());
        }
        ...
        public async Task<IActionResult> Create(InvestmentViewModel vm)
        {
            ...
            {
                TickerSymbol = vm.TickerSymbol.ToUpper(),
